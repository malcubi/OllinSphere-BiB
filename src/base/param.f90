!$Header: /usr/local/ollincvs/Codes/OllinSphere-BiB/src/base/param.f90,v 1.161 2023/08/22 17:57:40 malcubi Exp $
...
! Kreiss-Oliger dissipation coefficients.  It is better if they are independent.
  ...
  real(8) :: fluiddiss  = 0.01d0      ! Dissipation for fluids.
...
!
! fluid_q1:          Coefficient of linear artificial dissipation.
! fluid_q2:          Coefficient of quadratic artificial dissipation.
!
